    ...
    <v-col>
      <v-card v-if="this.post.poster !== undefined">
        <v-card-title>
          ...
          <nuxt-link style="color: white; text-decoration: none;  margin-right: 1rem; margin-left: 1rem" :to="'/user?id='+this.post.poster_id">{{this.post.poster.firstname + " " + this.post.poster.lastname}}</nuxt-link>
      ...
      <v-card>
        <v-list v-if="this.Comments.length !== 0">
          ...
          <v-card style="margin-top: 1rem; margin-bottom: 1rem" v-key="comment.id" v-for="(comment,index) in this.Comments">
             <v-card-title>
               <v-avatar>
                 <v-img :src="'/media/avatar/'+comment.user.avatar.path"></v-img>
               </v-avatar>
               <p style="margin-left: 1rem; margin-right: 1rem">{{comment.user.firstname + " " + comment.user.lastname}}</p>
               <span style="font-size: 0.8rem">
